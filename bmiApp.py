...
height_cm = st.number_input("กรอกส่วนสูงของคุณ (เซนติเมต):")

#ส่วนที่ 3 สร้างปุ่มกดคำนวณ
if st.button("คำนวณค่า BMI 🎯 "):
    # แปลงส่วงสูงจาก cm เป็น เมตร แล้วคำนวณ BMI 
...
if bmi < 18.5:
    ...
    st.success("🎉 คุณมีน้ำหนักอบู่ในเกณฑ์ปกติ (สุขภาพดี)")
elif 23.0 <= bmi < 25.0:
...
st.divider()
st.write("นางสางวเกณิกา พูลทะจักร์ เลขที่ 21 ม.4/7")
